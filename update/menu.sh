...
Isadmin=$(curl -sS https://raw.githubusercontent.com/botak8/testes/main/ipmini | grep $MYIP | awk '{print $5}')
...
Exp=$(curl -sS https://raw.githubusercontent.com/botak8/testes/main/ipmini | grep $MYIP | awk '{print $3}')
fi
export RED='\033[0;31m'
